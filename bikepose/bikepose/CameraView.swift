    ...
    var body: some View {
        NavigationView {
                    ...
                    if let image = selectedImage {
                        ...
                        VStack {
                            ...
                            .alert(isPresented: $showInfoAlert) {
                                Alert(
                                    title: Text("How to Take a Proper Picture"),
                                    message: Text("""
                                        For the best results in pose analysis, please follow these guidelines:
                                        
                                        - Ensure there is exactly one person on the picture.
                                        - Make sure the picture is clear and not blurry.
                                        - Take the picture from exactly the right or left side of the bike.
                                        - Select the side in the toggle bar below, as the chosen side will be prioritized for analysis.
                                        
                                        Following these tips will help provide the most accurate pose analysis.
                                        """),
            ...
            .navigationDestination(isPresented: $navigateToPoseAnalyzer) {
                if let image = selectedImage {
                    PoseAnalytics(image: image, selectedPosition: selectedPosition)
                }
            }
        }
    }
